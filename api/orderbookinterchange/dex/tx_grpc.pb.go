...
const (
	...
	Msg_CancelSellOrder_FullMethodName = "/orderbookinterchange.dex.Msg/CancelSellOrder"
	Msg_CancelBuyOrder_FullMethodName  = "/orderbookinterchange.dex.Msg/CancelBuyOrder"
)
