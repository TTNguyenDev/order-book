...
func (x *fastReflection_DexPacketData) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "orderbookinterchange.dex.DexPacketData.buyOrderPacket":
		if x.Packet == nil {
			return false
...
func init() {
	file_orderbookinterchange_dex_packet_proto_init()
	md_BuyOrderPacketData = File_orderbookinterchange_dex_packet_proto.Messages().ByName("BuyOrderPacketData")
...
func (x *BuyOrderPacketData) slowProtoReflect() protoreflect.Message {
	mi := &file_orderbookinterchange_dex_packet_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_BuyOrderPacketData) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "orderbookinterchange.dex.BuyOrderPacketData.amountDenom":
		return x.AmountDenom != ""
	case "orderbookinterchange.dex.BuyOrderPacketData.amount":
		return x.Amount != int32(0)
	case "orderbookinterchange.dex.BuyOrderPacketData.priceDenom":
		return x.PriceDenom != ""
	case "orderbookinterchange.dex.BuyOrderPacketData.price":
		return x.Price != int32(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: orderbookinterchange.dex.BuyOrderPacketData"))
		}
		panic(fmt.Errorf("message orderbookinterchange.dex.BuyOrderPacketData does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_BuyOrderPacketData) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message orderbookinterchange.dex.BuyOrderPacketData does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_BuyOrderPacketData) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "orderbookinterchange.dex.BuyOrderPacketData.amountDenom":
		panic(fmt.Errorf("field amountDenom of message orderbookinterchange.dex.BuyOrderPacketData is not mutable"))
	case "orderbookinterchange.dex.BuyOrderPacketData.amount":
		panic(fmt.Errorf("field amount of message orderbookinterchange.dex.BuyOrderPacketData is not mutable"))
	case "orderbookinterchange.dex.BuyOrderPacketData.priceDenom":
		panic(fmt.Errorf("field priceDenom of message orderbookinterchange.dex.BuyOrderPacketData is not mutable"))
	case "orderbookinterchange.dex.BuyOrderPacketData.price":
		panic(fmt.Errorf("field price of message orderbookinterchange.dex.BuyOrderPacketData is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: orderbookinterchange.dex.BuyOrderPacketData"))
		}
...
func (x *fastReflection_BuyOrderPacketData) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in orderbookinterchange.dex.BuyOrderPacketData", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_orderbookinterchange_dex_packet_proto_init()
	md_BuyOrderPacketAck = File_orderbookinterchange_dex_packet_proto.Messages().ByName("BuyOrderPacketAck")
...
func (x *BuyOrderPacketAck) slowProtoReflect() protoreflect.Message {
	mi := &file_orderbookinterchange_dex_packet_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_BuyOrderPacketAck) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "orderbookinterchange.dex.BuyOrderPacketAck.remainingAmount":
		return x.RemainingAmount != int32(0)
	case "orderbookinterchange.dex.BuyOrderPacketAck.purchase":
		return x.Purchase != int32(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: orderbookinterchange.dex.BuyOrderPacketAck"))
		}
		panic(fmt.Errorf("message orderbookinterchange.dex.BuyOrderPacketAck does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_BuyOrderPacketAck) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message orderbookinterchange.dex.BuyOrderPacketAck does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_BuyOrderPacketAck) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "orderbookinterchange.dex.BuyOrderPacketAck.remainingAmount":
		panic(fmt.Errorf("field remainingAmount of message orderbookinterchange.dex.BuyOrderPacketAck is not mutable"))
	case "orderbookinterchange.dex.BuyOrderPacketAck.purchase":
		panic(fmt.Errorf("field purchase of message orderbookinterchange.dex.BuyOrderPacketAck is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: orderbookinterchange.dex.BuyOrderPacketAck"))
		}
...
func (x *fastReflection_BuyOrderPacketAck) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in orderbookinterchange.dex.BuyOrderPacketAck", d.FullName()))
	}
	panic("unreachable")
}
...
func (*BuyOrderPacketData) Descriptor() ([]byte, []int) {
	return file_orderbookinterchange_dex_packet_proto_rawDescGZIP(), []int{6}
}
...
func (*BuyOrderPacketAck) Descriptor() ([]byte, []int) {
	return file_orderbookinterchange_dex_packet_proto_rawDescGZIP(), []int{7}
}
...
var file_orderbookinterchange_dex_packet_proto_rawDesc = []byte{
	...
	0x78, 0x22, 0xe6, 0x02, 0x0a, 0x0d, 0x44, 0x65, 0x78, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x44,
	...
	0x65, 0x72, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x12, 0x56, 0x0a, 0x0e, 0x62, 0x75, 0x79, 0x4f,
	0x72, 0x64, 0x65, 0x72, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x2c, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x62, 0x6f, 0x6f, 0x6b, 0x69, 0x6e, 0x74, 0x65,
	...
	,
	...
	,
	...
	0x69, 0x6e, 0x67, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x75, 0x72,
	0x63, 0x68, 0x61, 0x73, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x70, 0x75, 0x72,
	0x63, 0x68, 0x61, 0x73, 0x65, 0x42, 0xd7, 0x01, 0x0a, 0x1c, 0x63, 0x6f, 0x6d, 0x2e, 0x6f, 0x72,
	0x64, 0x65, 0x72, 0x62, 0x6f, 0x6f, 0x6b, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x63, 0x68, 0x61, 0x6e,
	0x67, 0x65, 0x2e, 0x64, 0x65, 0x78, 0x42, 0x0b, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x50, 0x72,
...
var file_orderbookinterchange_dex_packet_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_orderbookinterchange_dex_packet_proto_goTypes = []interface{}{
	...
	(*BuyOrderPacketData)(nil),   // 6: orderbookinterchange.dex.BuyOrderPacketData
	(*BuyOrderPacketAck)(nil),    // 7: orderbookinterchange.dex.BuyOrderPacketAck
}
var file_orderbookinterchange_dex_packet_proto_depIdxs = []int32{
	...
	6, // 3: orderbookinterchange.dex.DexPacketData.buyOrderPacket:type_name -> orderbookinterchange.dex.BuyOrderPacketData
...
func file_orderbookinterchange_dex_packet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_orderbookinterchange_dex_packet_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_orderbookinterchange_dex_packet_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
