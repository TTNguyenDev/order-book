...
func init() {
	...
	md_BuyOrderBook = File_orderbookinterchange_dex_buy_order_book_proto.Messages().ByName("BuyOrderBook")
...
func (x *BuyOrderBook) slowProtoReflect() protoreflect.Message {
	mi := &file_orderbookinterchange_dex_buy_order_book_proto_msgTypes[0]
...
func (x *fastReflection_BuyOrderBook) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "orderbookinterchange.dex.BuyOrderBook.index":
		return x.Index != ""
	case "orderbookinterchange.dex.BuyOrderBook.amountDenom":
		return x.AmountDenom != ""
	case "orderbookinterchange.dex.BuyOrderBook.priceDenom":
		return x.PriceDenom != ""
	case "orderbookinterchange.dex.BuyOrderBook.book":
		return x.Book != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: orderbookinterchange.dex.BuyOrderBook"))
		}
		panic(fmt.Errorf("message orderbookinterchange.dex.BuyOrderBook does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_BuyOrderBook) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message orderbookinterchange.dex.BuyOrderBook does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_BuyOrderBook) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "orderbookinterchange.dex.BuyOrderBook.index":
		panic(fmt.Errorf("field index of message orderbookinterchange.dex.BuyOrderBook is not mutable"))
	case "orderbookinterchange.dex.BuyOrderBook.amountDenom":
		panic(fmt.Errorf("field amountDenom of message orderbookinterchange.dex.BuyOrderBook is not mutable"))
	case "orderbookinterchange.dex.BuyOrderBook.priceDenom":
		panic(fmt.Errorf("field priceDenom of message orderbookinterchange.dex.BuyOrderBook is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: orderbookinterchange.dex.BuyOrderBook"))
		}
...
func (x *fastReflection_BuyOrderBook) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in orderbookinterchange.dex.BuyOrderBook", d.FullName()))
	}
	panic("unreachable")
}
...
func (*BuyOrderBook) Descriptor() ([]byte, []int) {
	return file_orderbookinterchange_dex_buy_order_book_proto_rawDescGZIP(), []int{0}
}
...
var File_orderbookinterchange_dex_buy_order_book_proto protoreflect.FileDescriptor

var file_orderbookinterchange_dex_buy_order_book_proto_rawDesc = []byte{
	0x0a, 0x2d, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x62, 0x6f, 0x6f, 0x6b, 0x69, 0x6e, 0x74, 0x65, 0x72,
	...
	0x18, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x62, 0x6f, 0x6f, 0x6b, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x63,
	0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e, 0x64, 0x65, 0x78, 0x1a, 0x24, 0x6f, 0x72, 0x64, 0x65, 0x72,
	0x62, 0x6f, 0x6f, 0x6b, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x2f,
	0x64, 0x65, 0x78, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22,
	...
	,
}

var (
	file_orderbookinterchange_dex_buy_order_book_proto_rawDescOnce sync.Once
	file_orderbookinterchange_dex_buy_order_book_proto_rawDescData = file_orderbookinterchange_dex_buy_order_book_proto_rawDesc
)

func file_orderbookinterchange_dex_buy_order_book_proto_rawDescGZIP() []byte {
	file_orderbookinterchange_dex_buy_order_book_proto_rawDescOnce.Do(func() {
		file_orderbookinterchange_dex_buy_order_book_proto_rawDescData = protoimpl.X.CompressGZIP(file_orderbookinterchange_dex_buy_order_book_proto_rawDescData)
	})
	return file_orderbookinterchange_dex_buy_order_book_proto_rawDescData
}

var file_orderbookinterchange_dex_buy_order_book_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_orderbookinterchange_dex_buy_order_book_proto_goTypes = []interface{}{
	(*BuyOrderBook)(nil), // 0: orderbookinterchange.dex.BuyOrderBook
	(*OrderBook)(nil),    // 1: orderbookinterchange.dex.OrderBook
}
var file_orderbookinterchange_dex_buy_order_book_proto_depIdxs = []int32{
	1, // 0: orderbookinterchange.dex.BuyOrderBook.book:type_name -> orderbookinterchange.dex.OrderBook
...
func init() { file_orderbookinterchange_dex_buy_order_book_proto_init() }
func file_orderbookinterchange_dex_buy_order_book_proto_init() {
	if File_orderbookinterchange_dex_buy_order_book_proto != nil {
		return
	}
	file_orderbookinterchange_dex_order_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_orderbookinterchange_dex_buy_order_book_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_orderbookinterchange_dex_buy_order_book_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_orderbookinterchange_dex_buy_order_book_proto_goTypes,
		DependencyIndexes: file_orderbookinterchange_dex_buy_order_book_proto_depIdxs,
		MessageInfos:      file_orderbookinterchange_dex_buy_order_book_proto_msgTypes,
	}.Build()
	File_orderbookinterchange_dex_buy_order_book_proto = out.File
	file_orderbookinterchange_dex_buy_order_book_proto_rawDesc = nil
	file_orderbookinterchange_dex_buy_order_book_proto_goTypes = nil
	file_orderbookinterchange_dex_buy_order_book_proto_depIdxs = nil
}
