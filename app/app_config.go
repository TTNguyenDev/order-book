...
import (
	...
	dexmodulev1 "orderbook-interchange/api/orderbookinterchange/dex/module"
	_ "orderbook-interchange/x/dex/module" // import for side-effects
	dexmoduletypes "orderbook-interchange/x/dex/types"
