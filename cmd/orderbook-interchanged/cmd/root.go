...
import (
	...
	"orderbook-interchange/app"
)

// NewRootCmd creates a new root command for orderbook-interchanged. It is called once in the main function.
func NewRootCmd() *cobra.Command {
	...
	rootCmd := &cobra.Command{
		Use:           app.Name + "d",
		Short:         "Start orderbookinterchange node",
		SilenceErrors: true,
